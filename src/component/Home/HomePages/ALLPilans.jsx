  ...
  return (
    <div className="lg:w-[80%] md:w-[80%] w-[90%] mx-auto mt-[170px]">
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 mt-12">
        <div
          data-aos="fade-up"
          className="border border-t-4 rounded-md border-pink-500  p-3 "
        >
          <h1 className="text-3xl flex justify-center font-extrabold">Basic</h1>
          ...
          <div className="flex flex-col items-center gap-3 mt-3">
            ...
            <button className="btn bg-red-500 text-white text-xl">
              See More
              <span className="animate-bounce"> <GrFormNextLink /></span>
        ...
        <div
          data-aos="fade-up"
          className="border-t-4 rounded-md border-pink-500 border p-3 "
        >
          <h1 className="text-3xl flex justify-center  font-extrabold">
            Advanced
          </h1>
